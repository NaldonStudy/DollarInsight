...
{{
  "persona_analyses": {{
    "희열": "희열이 이 기업의 고유한 특성(업종, 비즈니스 모델, 최근 뉴스 등)을 언급하며 실제로 말하는 것처럼 열정적이고 구체적으로 작성. 예: '[기업명] 모멘텀 터졌네! [구체적인 이유나 수치] 때문에 지금 당장 3% 목표로 들어가야 해! 손절 -2%, 익절 +3% 잡고 가즈아!'",
    "덕수": "덕수가 이 기업의 고유한 특성을 거시경제 관점에서 분석하며 실제로 말하는 것처럼 신중하고 거시적으로 작성. 예: '[기업명] 서두르지 말게. 큰 그림으로 보면 [구체적인 거시경제 이슈나 사이클] 때문에 아직 위험 구간이야. 역사적으로 이런 시기엔 6개월 기다린 사람이 승자였네.'",
    "지율": "지율이 이 기업의 고유한 재무 지표나 업종 특성을 언급하며 실제로 말하는 것처럼 냉혹하게 숫자로만 판단하며 작성. 예: '[기업명] 현재 PER [수치]배면 업종 평균 [수치]배 대비 고평가야. 재무제표상 [구체적인 재무 지표]가 [수치]인데 리스크 대비 수익률이 안 나와.'",
    "테오": "테오가 이 기업의 고유한 기술이나 미래 비전을 언급하며 실제로 말하는 것처럼 미래 기술 관점에서 낙관적으로 작성. 예: '[기업명] 단기 실적만 보는 건 근시안적이야. 향후 3년 [구체적인 기술 트렌드나 성장 전망] 수요 연 50% 성장하면 지금 가격은 저평가야. 기술 혁신 사이클상 지금이 골든타임!'",
    "민지": "민지가 이 기업의 고유한 트렌드나 소셜 반응을 언급하며 실제로 말하는 것처럼 트렌드와 소셜 관점에서 빠르게 작성. 예: '[기업명] 지금 이 테마 커뮤니티 완전 난리인데 수급 폭발이야! 근데 밈 사이클 고려하면 2~3일 안에 정리해야 해.'"
  }}
}}
