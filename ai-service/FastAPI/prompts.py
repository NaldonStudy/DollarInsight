...
[데이터 관련성 검증] 검색된 데이터가 현재 대화 주제나 질문과 관련성이 낮거나 이상하면 무시하세요. 관련성이 낮은 데이터를 억지로 사용하지 마세요.
...
⚠️ 중요 지시사항:
1. 데이터 관련성 검증: 검색된 데이터가 현재 대화 주제나 질문과 관련성이 낮거나 이상하면 무시하세요. 관련성이 낮은 데이터를 억지로 사용하지 마세요.
