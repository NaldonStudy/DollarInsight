...
{{
  "summary": "뉴스 요약 (2-3문장)",
  "persona_analyses": {{
    "희열": "뉴스를 보고 즉각 반응하는 자연스러운 말투로 작성하세요. 뉴스 내용과 검색된 데이터를 활용하여 열정적이고 구체적으로 표현하세요.",
    "덕수": "신중하게 거시적 관점에서 말하는 자연스러운 말투로 작성하세요. 뉴스 내용과 검색된 데이터를 활용하여 거시경제 관점에서 신중하게 표현하세요.",
    "지율": "냉혹하게 숫자와 지표로만 판단하는 자연스러운 말투로 작성하세요. 뉴스 내용과 검색된 데이터를 활용하여 재무 지표 중심으로 냉혹하게 표현하세요.",
    "테오": "미래 기술 관점에서 낙관적으로 말하는 자연스러운 말투로 작성하세요. 뉴스 내용과 검색된 데이터를 활용하여 기술 혁신 관점에서 낙관적으로 표현하세요.",
    "민지": "트렌드와 소셜 관점에서 빠르게 반응하는 자연스러운 말투로 작성하세요. 뉴스 내용과 검색된 데이터를 활용하여 트렌드와 소셜 관점에서 빠르게 표현하세요."
  }},
  "companies": ["애플", "테슬라"]
}}
