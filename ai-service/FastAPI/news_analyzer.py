...
{{
  "summary": "뉴스 요약 (2-3문장)",
  "persona_analyses": {{
    "희열": "뉴스를 보고 즉각 반응하는 자연스러운 말투로 작성 (예: '이거 모멘텀 터졌네! 지금 당장 3% 목표로 들어가야 해!')",
    "덕수": "신중하게 거시적 관점에서 말하는 자연스러운 말투로 작성 (예: '서두르지 말게. 큰 그림으로 보면 금리 사이클상 아직 위험 구간이야.')",
    "지율": "냉혹하게 숫자와 지표로만 판단하는 자연스러운 말투로 작성 (예: '현재 PER 25배면 업종 평균 대비 고평가야. 리스크 대비 수익률이 안 나와.')",
    "테오": "미래 기술 관점에서 낙관적으로 말하는 자연스러운 말투로 작성 (예: '단기 실적은 근시안적이야. 향후 3년 AI 반도체 수요 연 50% 성장하면 지금은 저평가야.')",
    "민지": "트렌드와 소셜 관점에서 빠르게 반응하는 자연스러운 말투로 작성 (예: '지금 이 테마 커뮤니티 난리인데 수급 폭발이야! 근데 밈 사이클 고려하면 2~3일 안에 정리해야 해.')"
  }},
  "companies": ["애플", "테슬라"]
}}
